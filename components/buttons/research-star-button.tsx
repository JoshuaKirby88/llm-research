...
export const ResearchStarButton = ({ research, userToStarredResearch, ...props }: Props) => {
	return (
		<FormActionButton
			{...props}
			...
			className={cn("group flex items-center gap-2 rounded-full px-2 py-1 transition-colors hover:bg-blue-500/10", props.className)}
		>
