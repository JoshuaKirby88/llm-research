...
import { dateFilterOperators, filterTypeOperatorDetails, multiOptionFilterOperators, numberFilterOperators, optionFilterOperators, textFilterOperators } from "../core/operators"
...
export function FilterOperatorController<TData, TType extends ColumnDataType>({ filter, column, actions, closeController, locale = "en" }: FilterOperatorControllerProps<TData, TType>) {
	switch (column.type) {
		...
		case "date":
			return <FilterOperatorDateController filter={filter as FilterModel<"date">} column={column as Column<TData, "date">} actions={actions} closeController={closeController} locale={locale} />
		case "text":
			return <FilterOperatorTextController filter={filter as FilterModel<"text">} column={column as Column<TData, "text">} actions={actions} closeController={closeController} locale={locale} />
		case "number":
			return (
...
function FilterOperatorMultiOptionController<TData>({ filter, column, actions, closeController, locale = "en" }: FilterOperatorControllerProps<TData, "multiOption">) {
